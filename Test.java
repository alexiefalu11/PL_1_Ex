/* Proyecto #1 Movie database
   ...
   Clase Test la cual contiene el Main
   para poder ejecutar programa
 ...
 */
 ...
 public class Test{
	 ...
	 /*Muestra menu para poder recibir la selección 
	   del usuario*/
	 static int Menu(){
	...
	/*Añadir nuevo genero(nodo) al usuario insertar titulo de genero */
